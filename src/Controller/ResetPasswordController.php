...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MessageBusInterface $messageBus): RedirectResponse
    {
...
//        ;
        $data = [
          'from' => 'shumonsb@gmail.com',
          'fromName' => 'CoVi Analytics',
          'to' => $user->getEmail(),
        ...
        $messageBus->dispatch(new PracticeMail($data));
